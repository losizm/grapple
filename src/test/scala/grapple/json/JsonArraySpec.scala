...
class JsonArraySpec extends org.scalatest.flatspec.AnyFlatSpec:
  it should "create JsonArray" in {
    ...
    assertThrows[JsonExpectationError](user.getObject(0))
    assertThrows[JsonExpectationError](user.getArray(0))
    assertThrows[JsonExpectationError](user.getString(0))
    ...
    assertThrows[JsonExpectationError](user.getBoolean(0))
    assert(!user.isNull(0))

    assertThrows[JsonExpectationError](user.getObject(1))
    assertThrows[JsonExpectationError](user.getArray(1))
    assert(user.getString(1) == "lupita")
    assertThrows[JsonExpectationError](user.getInt(1))
    assertThrows[JsonExpectationError](user.getLong(1))
    assertThrows[JsonExpectationError](user.getFloat(1))
    assertThrows[JsonExpectationError](user.getDouble(1))
    assertThrows[JsonExpectationError](user.getBigInt(1))
    assertThrows[JsonExpectationError](user.getBigDecimal(1))
    assertThrows[JsonExpectationError](user.getBoolean(1))
    assert(!user.isNull(1))

    assertThrows[JsonExpectationError](user.getObject(2))
    assert(user.getArray(2) == JsonArray(Seq(JsonString("lupita"), JsonString("admin"), JsonNumber(100))))
    assertThrows[JsonExpectationError](user.getString(2))
    assertThrows[JsonExpectationError](user.getInt(2))
    assertThrows[JsonExpectationError](user.getLong(2))
    assertThrows[JsonExpectationError](user.getFloat(2))
    assertThrows[JsonExpectationError](user.getDouble(2))
    assertThrows[JsonExpectationError](user.getBigInt(2))
    assertThrows[JsonExpectationError](user.getBigDecimal(2))
    assertThrows[JsonExpectationError](user.getBoolean(2))
    assert(!user.isNull(2))

    assertThrows[JsonExpectationError](user.getObject(3))
    assertThrows[JsonExpectationError](user.getArray(3))
    assertThrows[JsonExpectationError](user.getString(3))
    assertThrows[JsonExpectationError](user.getInt(3))
    assertThrows[JsonExpectationError](user.getLong(3))
    assertThrows[JsonExpectationError](user.getFloat(3))
    assertThrows[JsonExpectationError](user.getDouble(3))
    assertThrows[JsonExpectationError](user.getBigInt(3))
    assertThrows[JsonExpectationError](user.getBigDecimal(3))
    ...
    assertThrows[JsonExpectationError](user.getArray(4))
    assertThrows[JsonExpectationError](user.getString(4))
    assertThrows[JsonExpectationError](user.getInt(4))
    assertThrows[JsonExpectationError](user.getLong(4))
    assertThrows[JsonExpectationError](user.getFloat(4))
    assertThrows[JsonExpectationError](user.getDouble(4))
    assertThrows[JsonExpectationError](user.getBigInt(4))
    assertThrows[JsonExpectationError](user.getBigDecimal(4))
    assertThrows[JsonExpectationError](user.getBoolean(4))
    assert(!user.isNull(4))

    assertThrows[JsonExpectationError](user.getObject(5))
    assertThrows[JsonExpectationError](user.getArray(5))
    assertThrows[JsonExpectationError](user.getString(5))
    assertThrows[JsonExpectationError](user.getInt(5))
    assertThrows[JsonExpectationError](user.getLong(5))
    assertThrows[JsonExpectationError](user.getFloat(5))
    assertThrows[JsonExpectationError](user.getDouble(5))
    assertThrows[JsonExpectationError](user.getBigInt(5))
    assertThrows[JsonExpectationError](user.getBigDecimal(5))
    assertThrows[JsonExpectationError](user.getBoolean(5))
    ...
    assertThrows[JsonExpectationError](user.read[String](0))
    assertThrows[JsonExpectationError](user.read[Boolean](0))
    assertThrows[JsonExpectationError](user.read[JsonString](0))
    assertThrows[JsonExpectationError](user.read[JsonArray](0))
