...
class JsonBuilderSpec extends org.scalatest.flatspec.AnyFlatSpec {
  ...
  "JSON builder" should "build array" in {
    Json.createArrayBuilder()
      ...
      .add(Success(user))
      .add(Failure[User](new Exception))
      ...
      .add(Array(0, 1, 2))
      .add(Seq[Short](0, 1, 2))
      .add(Array[Short](0, 1, 2))
      .add(Seq(0L, 1L, 2L))
      .add(Array(0L, 1L, 2L))
      .add(Seq(0.0, 1.0, 2.0))
      .add(Array(0.0, 1.0, 2.0))
      .add(Seq(0.0f, 1.0f, 2.0f))
      .add(Array(0.0f, 1.0f, 2.0f))
  ...
  it should "build object" in {
    Json.createObjectBuilder()
      ...
      .add("c3", Success(user))
      .add("c4", Failure[User](new Exception))
      ...
      .add("o1", Seq(0, 1, 2))
      .add("o2", Array(0, 1, 2))
      .add("o3", Seq[Short](0, 1, 2))
      .add("o4", Array[Short](0, 1, 2))
      .add("p1", Seq(0L, 1L, 2L))
      .add("p2", Array(0L, 1L, 2L))
      .add("q1", Seq(0.0, 1.0, 2.0))
      .add("q2", Array(0.0, 1.0, 2.0))
      .add("q3", Seq(0.0f, 1.0f, 2.0f))
      .add("q4", Array(0.0f, 1.0f, 2.0f))
